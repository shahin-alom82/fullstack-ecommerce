            ...
            <div className="py-10 max-w-screen-sm mx-auto">
                  <Container>
                        <form className="max-w-sm mx-auto border-b-4 border-t border-l border-r   border-gray-400  px-6 py-4">
                              ...
                              <p className="mt-2 text-center text-sm tracking-wide">Do not have an Account? <Link to={"/signup"}><span className="underline underline-offset-[5px]">Sign Up</span></Link></p>
                        </form>
